### INPUT ARGUMENTS
#1. theta value to use
#2. experimental profile
#3. calculated profiles file
#4. output dir

import numpy as np
import sys
import os, os.path
sys.path.append('/storage1/francesco/scripts/BME/') #CHECK THIS!!!! POINT IT TO THE FOLDER WHERE YOU HAVE THE BME CODE
...
print(dir_+" t"+sys.argv[1]+" CONVERGED")
